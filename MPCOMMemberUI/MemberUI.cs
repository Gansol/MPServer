...
namespace MPCOM
{
    ...
    {
        byte[] JoinMember(string account, string password, string nickname, int age, int sex, string IP, string email, string joinTime);
    ...
    public class MemberUI : ServicedComponent, IMemberUI
    {
        ...
        public byte[] JoinMember(string account, string password, string nickname, int age, int sex, string IP, string email, string joinTime)
        {
