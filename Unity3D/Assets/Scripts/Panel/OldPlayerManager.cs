...
public class OldPlayerManager : PanelManager
{
    #region 欄位
    /// <summary>
    ...
    private void Update()
    {
        ...
        if (assetLoader.loadedObj && _LoadedIcon)
        {
            ...
            InstantiateItemIcon(_dictItemData, PanelManager._lastEmptyItemGroup.transform, _itemType);
    ...
    private void LoadPlayerInfo()
    {
        ...
        parent.FindChild("WinRate").GetComponent<UILabel>().text = winRate.ToString() + " %";
