...
//    public string ReturnMessage { get { return AssetBundleManager.ReturnMessage; } }
//    private string[] dependenciesManifestAssetPath;
//    private AssetBundleManifest manifest;
//    private AssetBundle assetBundle;
//    private string manipath;
//    private List<string> loadedAtlasNamePath;

//    public AssetLoaderSystem(MPGame MPGame/*GameLoop gameLoop*/):base(MPGame)
//    {
...
//        loadedAtlasNamePath = new List<string>();
...
//                    {
//                        if (!loadedAtlasNamePath.Contains(dependencyManifestAssetPath))
//                        {
//                            loadedAtlasNamePath.Add(dependencyManifestAssetPath);
...
//        /*_gameLoop.*/
//        AssetBundleManager.Initialize();
//     m_MPGame.   StartCoroutine(AssetBundleManager.LoadAtlas(manifestAssetName.ToLower()/*, typeof(GameObject)*/));
//    }
...
//        bLoadedObj = false;
//        /* _gameLoop.*/
//        m_MPGame.StartCoroutine(AssetBundleManager.LoadGameObject(manifestAssetName.ToLower()));
//    }
