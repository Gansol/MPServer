...
public class MuchAnimState : AnimatorState {
 private bool _toFlag,_toScale;
    private Vector3 _toWorldPos,_scale;

    public MuchAnimState(GameObject obj, bool isBoss, float lerpSpeed, float upSpeed, float upDistance, float lifeTime)
    ...
    public override void UpdateAnimation()
    {
        ...
        if (_bMotion && _toScale && (Vector3.Distance(obj.transform.position, _toWorldPos) > 0)) // AnimationTo
            AnimationScale();
