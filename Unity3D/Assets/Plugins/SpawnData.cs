...
public static class SpawnData
{
    ...
    //private static readonly sbyte[] aLineL = { 0};
    ...
    private static readonly sbyte[,] aLinkHorTwin2D = { { 0, 3 }, { 4, 1 }, { 2, 5 }, { 11, 8 }, { 7, 10 }, { 9, 6 } };
    private static readonly sbyte[,] aLinkVertTwin2D = { { 1, 0 }, { 3, 4 }, { 7, 6 }, { 9, 10 }, { 11, 8 }, { 5, 2 } };
